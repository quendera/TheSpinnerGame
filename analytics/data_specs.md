...
#### :point_down: <details><summary>*Click here to expand organized version* </summary> 
 
The json above is organized here one key per line, ordered first by type (lists first, everything else second), category (`mo_`, `sw_`, etc.), and size (if list): 
